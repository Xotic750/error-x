...
var defContext = function _defContext(context, frames, name) {
  ...
  defineProperties(context, {
    ...
    stack: {
      value: "".concat(name, "\n    ").concat(map(frames, function (frame) {
...
export var create = function _createErrorCtr(name, ErrorCtr) {
  var ECTR = ErrorCtr;
...
export var AssertionErrorConstructor = create('AssertionError', Error);
/**
...
export var ErrorConstructor = create('Error', Error);
/**
...
export var EvalErrorConstructor = create('EvalError', EvalError); // noinspection JSUnusedGlobalSymbols
...
export var InternalErrorConstructor = create('InternalError', Error);
/**
...
export var RangeErrorConstructor = create('RangeError', RangeError);
/**
...
export var ReferenceErrorConstructor = create('ReferenceError', ReferenceError); // noinspection JSUnusedGlobalSymbols
...
export var SyntaxErrorConstructor = create('SyntaxError', SyntaxError);
/**
...
export var TypeErrorConstructor = create('TypeError', TypeError);
/**
...
export var URIErrorConstructor = create('URIError', URIError);
